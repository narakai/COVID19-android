...
public abstract class ChartUtils {
    ...
    public static final int COLOR_INS_GREEN = Color.parseColor("#6CE023");
    public static final int[] COLORS = new int[]{COLOR_INS_GREEN, COLOR_BLUE, COLOR_VIOLET, COLOR_GREEN, COLOR_ORANGE, COLOR_RED};
